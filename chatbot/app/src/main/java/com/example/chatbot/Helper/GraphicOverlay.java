...
public class GraphicOverlay extends View {
    ...
    //removes all graphic from the overlay
    public void clear() {
        synchronized (mLock) {
            mGraphics.clear();
        }
    ...
    //set the camera attributes for size and facing direction, which informs how to transform image coordinates later
    ...
    //draw the overlay with its associated graphic objects
    @Override
